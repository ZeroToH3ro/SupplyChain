...
export default ({getModel, setGetModel, getShipment }) => {
  ...
  console.log("singleShipmentData", singleShipmentData);
  ...
  return getModel ? (
      <div className="fixed inset-0 z-10 overflow-y-auto">
        ...
        <div className="flex items-center min-h-screeen px-4 py-8">
            ...
            <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
              ...
              {singleShipmentData == undefined ? (
                  ...
                  <div className="text-left">
                    ...
                    <p>Sender: {singleShipmentData.receiver.slice(0, 25)}...</p>
